...
import com.example.usman.youtubehashtag.Video_Objects.VideoItem;
import com.example.usman.youtubehashtag.Video_Objects.VideoItemTRL;
...
public class Videos_List extends Fragment {
    ...
    public void Drop_Down_List(final String title, final String url, final String id)
    {
        ...
        d.setContentView(R.layout.drop_down_favourite_share);
        d.setTitle("Options");
        window.setLayout(240, 350);

        d.show();
        Button favrt=(Button)d.findViewById(R.id.btn_dropdown_favrt);
        Button share=(Button)d.findViewById(R.id.btn_dropdown_share);
